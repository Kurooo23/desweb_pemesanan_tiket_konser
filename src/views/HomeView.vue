...
.search-icon  { @apply absolute right-5 top-1/2 -translate-y-1/2 text-[18px]; }
...
/* Card */
.concert-card      { @apply bg-linear-to-b from-[#f1f1f1] via-[#7a0202] to-[#3b0000] rounded-2xl overflow-hidden text-white flex flex-col; }

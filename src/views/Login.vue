...
/* ====== Info wallet ====== */
.wallet-info {
  @apply bg-linear-to-br from-[#667eea] to-[#764ba2] text-white p-4 rounded-[10px] mb-4;
...
/* Tombol MetaMask */
.btn-metamask {
  @apply bg-linear-to-br from-[#f6851b] to-[#e2761b] text-[#F4F1DE] inline-flex items-center justify-center gap-2.5 leading-none;
}
...
/* Tombol login */
.btn-login {
  @apply bg-linear-to-br from-[#41b883] to-[#35a372] text-white;
}
